...
# Wikipedia setup with custom User-Agent
wiki_wiki = wikipediaapi.Wikipedia(
   language='en',
   user_agent="AcademicAssistantBot/1.0 (https://your-website.com or email@example.com)"
)
...
def ask_bot(user_input):
   ...
   try:
       ...
       if watson_response:
           ...
           # If Watson doesn’t have an answer, search Wikipedia
